...
int main(int argc, const char** argv)
{
    ...
    nestedCascade.load("C:\\libs\\opencv\\sources\\data\\haarcascades\\haarcascade_eye_tree_eyeglasses.xml");

    // Change path before execution 
    cascade.load("C:\\libs\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalcatface.xml");
    ...
    if (capture.isOpened())
    {
        ...
        cout << "Yüz Tanýma baþlatýldý...." << endl;
        while (1)
        {
            capture >> frame;
            if (frame.empty())
